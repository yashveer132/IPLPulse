...
router.get(
  "/team-development/:franchiseId",
  advancedController.getTeamDevelopmentBreakdown,
);
router.get("/retentions", advancedController.getRetentionAnalytics);
router.get(
  "/franchise-intelligence",
  advancedController.getFranchiseIntelligenceScore,
);
...
router.get(
  ...
  advancedController.getPlayerValueBreakdown,
);

router.get("/fastest-milestone", advancedController.getFastestMilestone);
router.get(
  "/fastest-milestone-curve",
  advancedController.getFastestMilestoneCurve,
);
...
router.get(
  "/historical-rankings/:playerId",
  advancedController.getHistoricalRankings,
);
router.get(
  "/career-milestones/:playerId",
  advancedController.getCareerMilestones,
);
router.get(
  "/impact-differential/:playerId",
  advancedController.getImpactDifferential,
);
router.get(
  "/historical-rivalries/:playerId",
  advancedController.getHistoricalRivalries,
);
router.get(
  "/career-records/:playerId",
  advancedController.getCareerRecordsBook,
);
router.get("/player-dna/:playerId", advancedController.getPlayerDNA);
router.get(
  "/career-trajectory/:playerId",
  advancedController.getCareerTrajectory,
);
