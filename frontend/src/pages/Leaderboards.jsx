...
const RECORDS_CONFIG = [
  {
    ...
    records: [
      ...
      { id: 'career-100s', title: 'Most Hundreds', desc: 'Triple digit milestones.', icon: '💯' },
      { id: 'career-50s', title: 'Most Fifties', desc: 'Consistent half-centuries.', icon: '🏏' },
      {
        id: 'career-sixes',
  ...
  },
  {
    ...
    records: [
      ...
      { id: 'career-maidens', title: 'Most Maidens', desc: 'Perfect scoreless overs.', icon: '🔒' },
      {
        id: 'career-5w',
  ...
  },
  {
    ...
    records: [
      ...
      { id: 'career-runouts', title: 'Most Run Outs', desc: 'Bullseye hits.', icon: '🎯' },
    ],
  },
  {
    categoryId: 'unique',
  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: 'auto', p: 2 }}>
      <Box sx={{ mb: 5, textAlign: 'center' }}>
        ...
        >
          IPL Records Explorer
        </Typography>
        <Typography variant="h6" color="text.secondary">
          Dive deep into the most comprehensive collection of IPL records ever assembled.
        </Typography>
      </Box>
      ...
      <Paper sx={{ mb: 4, borderRadius: 3, overflow: 'hidden' }}>
        <Tabs
          ...
          variant="scrollable"
          scrollButtons="auto"
          sx={{ '& .MuiTab-root': { fontWeight: 700, fontSize: '1rem', py: 2 } }}
        >
