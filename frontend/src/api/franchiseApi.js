...
export const franchiseApi = {
  ...
  getFranchiseSquad: (id, season) =>
    apiClient.get(`/franchises/${id}/squad/${season}`),
  compareFranchises: (ids) =>
    apiClient.get("/franchises/compare", { params: { ids: ids.join(",") } }),
  getFranchiseIntelligence: (id) =>
    apiClient.get(`/franchises/${id}/intelligence`),
  ...
  getAuctionIntelligence: (id) =>
    apiClient.get(`/franchises/${id}/auction-intelligence`),
};
